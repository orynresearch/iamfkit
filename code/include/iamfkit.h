/*
 * iamfkit.h — Unified C wrapper for libiamf
 * Copyright (c) 2024-2026 Heath Garvin. All rights reserved.
 *
 * Provides a clean C API for IAMF audio decoding across language bindings (Python, Dart, etc.)
 */
...
/**
 * Set head rotation quaternion for binaural 3D rendering.
 */
